r"""Integration tests for `ScipyLBFGSBOptimizer.run()`: these drive `scipy.optimize.minimize`'s
L-BFGS-B implementation to convergence on concrete objectives, rather than exercising this thin
wrapper's own logic in isolation.
"""
