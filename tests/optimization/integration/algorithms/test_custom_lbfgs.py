r"""Integration tests for `CustomLBFGSOptimizer.run()`: these drive the full iterative loop,
composing the optimizer with a real line search and update-acceptance strategy against concrete
objectives, rather than exercising any single component in isolation.
"""
